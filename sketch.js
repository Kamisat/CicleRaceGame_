...
ciclistaPrincipal.setCollider('circle',0,0,650)
  
  
  
fimdeJogo = createSprite(550,150);
...
function draw() {
  ...
  text("Aperte a tecla direcional para cima para reiniciar o jogo!",325,200)
...
function ciclistaRosa(){
        ...
        CGRosa.add(jogador1);
  jogador1.setCollider('circle',0,0,400);
   jogador1.debug = true;
}
...
function ciclistaAmarelo(){
   ...
   jogador2.setCollider('circle',0,0,400);
   jogador2.debug = true;
}
...
function ciclistaVermelho(){
   ...
   jogador3.setCollider('circle',0,0,400);
   jogador3.debug = true;
}
